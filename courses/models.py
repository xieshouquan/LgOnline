...
class Lesson(models.Model):
    course=models.ForeignKey(Course,"课程名称",on_delete=models.CASCADE)
    name=models.CharField("章节名",max_length=100)
    create_time=models.DateTimeField("添加时间",auto_created=True)
...
class Video(models.Model):
    lesson=models.ForeignKey(Lesson,"章节",on_delete=models.CASCADE)
